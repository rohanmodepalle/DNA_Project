...
INSERT INTO `CorrectAnswer` VALUES (1,1,'Dependant on other question\'s performance.'),(2,1,'Maybe.'),(2,1,'Yes'),(3,1,'(a) Achieve knowledge'),(3,1,'(b) Had fun'),(3,1,'(c) Liked the course'),(1,2,'Im good bro');
...
INSERT INTO `Examination` VALUES (2,1,3,'Audio1_2.mp3','Video1_2.mp4');
...
INSERT INTO `Examinee` VALUES ('Priyanshul',2,'9267910962','priyanshul.govil@research.iiit.ac.in',NULL,NULL,'dark',1),('Rohan',3,'9898989898','rohan@gmail.com','Airpods',NULL,'light',4),('Radheshyam',4,'9482103711','radheshyam@gmail.com',NULL,NULL,'light',4),('Hari',5,'9899705327','hari@gmail.com',NULL,NULL,'light',4),('Shreyas',6,'8860752347','shreyas@gmail.com',NULL,NULL,'light',3),('Pallav',7,'9673401298','pallavk@gmail.com',NULL,NULL,'light',4);
...
INSERT INTO `Question` VALUES (2,1,1,10,'How many marks do you think you\'ll get in this test?'),(2,1,2,20,'How are you?'),(1,2,1,10,'Do you think that question 1 is justified?'),(2,3,1,5,'Congrats on completing the course. Did you (a) Achieve knowledge (b) Had fun (c) Liked the course?');
...
INSERT INTO `QuestionImage` VALUES (3,1,'https://imgur.com/gallery/ei9D7KF');
...
INSERT INTO `Test` VALUES (1,'2021-10-27 12:00:00',3600,3,25,4),(2,'2021-10-29 10:00:00',4800,1,20,2),(3,'2021-11-02 13:30:00',1800,0,0,4),(4,'2021-12-15 10:00:00',2500,0,0,4),(5,'2022-01-01 00:00:00',3600,0,0,4);
...
-- Dump completed on 2021-10-26 15:41:22
